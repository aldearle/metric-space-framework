...
distDiffs = abs(dists(1:number,1) - dists(1:number,2))

midFocalLength = euc(pivots(1,:),pivots(2,:)) / 2;
difference = median(distDiffs)/2;
...
plotHyperbolaLine(midFocalLength,difference);
plotHyperbolaLine(midFocalLength,threshold);
